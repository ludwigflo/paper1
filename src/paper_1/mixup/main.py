...
def train(model: nn.Module, optimizer: Adam, metric_object: ClassificationMetrics, num_train_iter: int, metric_params: dict,
          train_loader_src: Generator, train_loader_tar: Generator, val_loader_list: list, src_domain: str, writer: SummaryWriter,
    ...
    for epoch in range(num_epochs):
        ...
        train_metrics = train_epoch(model, optimizer, metric_object, num_train_iter, metric_params,
                                    train_loader_src, train_loader_tar, src_domain)
...
def main(main_params: dict, data_params: dict, metric_params: dict, model_params: dict,
    ...
    train(model, optimizer, metric_object, num_train_iter, metric_params, train_loader_src, train_loader_tar,
...
if __name__ == '__main__':
    ...
    source_domains = ['Sexual Orientation']
    target_domains = ['Race']
