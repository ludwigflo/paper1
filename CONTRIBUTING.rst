...
Welcome to ``paper_1`` contributor's guide.
...
If you experience bugs or general issues with ``paper_1``, please have a look
...
You can help improve ``paper_1`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``paper_1`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``paper_1``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n paper_1 python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/paper_1.git
    cd paper_1
...
#. Install |pre-commit|_::
   ...
   ``paper_1`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/paper_1
.. _issue tracker: https://github.com/<USERNAME>/paper_1/issues
.. <-- end -->
